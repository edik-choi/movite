...
const _routes = [
  {
    name: "admin",
    path: "/admin",
    component: () => import('./index-Cs49Z2gn.mjs')
  },
  {
    name: "custom",
    path: "/custom",
    component: () => import('./index-BQHejnps.mjs')
  },
  {
    name: "index",
    path: "/",
    component: () => import('./index-VacK0jYO.mjs')
  }
];
...
const components_plugin_pVO71DSJyT = /* @__PURE__ */ defineNuxtPlugin({
...
const plugins = [
  ...
  components_plugin_pVO71DSJyT,
  axios_QMFgzss1s4
];
const layouts = {
  default: () => import('./default-QnkN7axc.mjs')
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-CZHHfQng.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-BVUeMhFu.mjs'));
